...
public class RunView extends View implements View.OnClickListener {
    ...
    private float verticalSpacing=0; //竖直矩形间的间距
    ...
    private int breakTime=runTime/200;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int verticalRectNumber = (int) ((height-BORDER_LENGTH*2-MAGIN*2) / (BORDER_LENGTH+horizontalSpacing));//如果不考虑间距，这可以画这么多个矩形
        verticalNumber=verticalRectNumber; //这里用3个矩形的位置的空间来做矩形间的间距
